...
void LibCamera::configureStill(int width, int height, PixelFormat format, int buffercount, int rotation) {
    ...
    // Set sensor mode to "'SRGGB10_CSI2P' : 1332x990 [120.05 fps - (696, 528)/2664x1980 crop]".
    config_->sensorConfig = SensorConfiguration { 10, Rectangle{ 0, 0, width, height }, {}, {}, Size{ width, height } };
